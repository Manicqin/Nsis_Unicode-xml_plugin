...
namespace TinyXPath
{
   ...
   /// Static function to compute a node XPath expression, without an error check
   bool o_xpath_node (const TiXmlNode * XNp_source_tree, const char * cp_xpath_expr, TiXmlNode * XNp_node)
   {
      unsigned u_nb;
   ...
   /// Static function to compute an attribute XPath expression, without an error check
   bool o_xpath_attribute (const TiXmlNode * XNp_source_tree, const char * cp_xpath_expr, TiXmlAttribute * XAp_attrib)
   {
      unsigned u_nb;
