...
namespace TinyXPath
{
   ...
   extern bool o_xpath_node (const TiXmlNode * XNp_source_tree, const char * cp_xpath_expr, TiXmlNode * XNp_node);
   extern bool o_xpath_attribute (const TiXmlNode * XNp_source_tree, const char * cp_xpath_expr, TiXmlAttribute * XAp_attrib);
}
